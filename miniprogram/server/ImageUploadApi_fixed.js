    ...
    return new Promise((resolve, reject) => {
      wx.getImageInfo({
        ...
        success: (imageInfo) => {
          ...
          console.log('ImageUploadApi_fixed压缩前图片尺寸:', imageInfo.width, 'x', imageInfo.height)
          console.log('ImageUploadApi_fixed压缩后图片尺寸:', width, 'x', height)
          ...
          canvas.draw(false, () => {
            ...
            setTimeout(() => {
              ...
              wx.canvasToTempFilePath({
                ...
                fileType: 'jpg', // 指定文件类型
                success: (res) => {
                  console.log('ImageUploadApi_fixed图片压缩成功:', res.tempFilePath)
                  resolve({
                ...
                fail: (error) => {
                  console.log('ImageUploadApi_fixed图片压缩失败，使用原图:', error)
                  resolve({
